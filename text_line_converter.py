...
def get_capitalize_the_first_letter_line(text): 

    the_first_letter_line = ""
    words = re.split(' |\n|\r', text)
    ...
    for idx, word in enumerate(words):
        if idx == 0:
            ...
            pass
        the_first_letter_line += word + " " 
    
    the_first_letter_line = ' '.join(the_first_letter_line.split())
    the_first_letter_line = the_first_letter_line.strip() 

    return the_first_letter_line
...
def entry_line():        
    ...
    the_first_letter_line = get_capitalize_the_first_letter_line(original_line)
    ...
    e2.insert(0, the_first_letter_line)   

    e3.delete(0, len(e3.get()))             
    e3.insert(0, case_sensitive_line)       

    e4.delete(0, len(e4.get()))             
    e4.insert(0, one_line)       

    e5.delete(0, len(e5.get()))             
    e5.insert(0, clean_line)  

    return the_first_letter_line, case_sensitive_line, one_line, clean_line

def capitalize_the_first_letter():    
    the_first_letter_line, case_sensitive_line, one_line, clean_line  = entry_line()
    clipboard.copy(the_first_letter_line)
...
l3 = Label(window, text = 'The first letter Line ')
l4 = Label(window, text = 'Case Sensitive Line ')
l5 = Label(window, text = 'One Line ')
l6 = Label(window, text = 'Clean Line ')
l7 = Label(window, text = 'Copy Machine')
l1.place(x=20, y=10)
l2.place(x=20, y=60)
l3.place(x=20, y=140)
l4.place(x=20, y=220)
...
e5.place(x=175, y=380, width=400, height=50)

b1 = Button(window, text = "The first letter Line", command=capitalize_the_first_letter)
b2 = Button(window, text = "Case Sensitive Line", command=case_senstive)  
b3 = Button(window, text = "One Line", command=one)   
b4 = Button(window, text = "Clean Line", command=clean)
b1.place(x=20, y=500)
b2.place(x=160, y=500)
b3.place(x=300, y=500)
b4.place(x=385, y=500)
window.mainloop()